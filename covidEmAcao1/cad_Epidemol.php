    ...
    <body>
        ...
        <div class="fundo">
            ...
            <form method="POST" action="proc_cad_epidemol.php">
                <label>Casos: </label>
                <input type="number" name="casos" placeholder="Indique a quantidade" id="campo"><br><br>
                
                <label>Óbitos: </label>
                <input type="number" name="obitos" placeholder="Indique a quantidade" id="campo"><br><br>
