...
if(mysqli_affected_rows($conn)){
    $_SESSION['msg'] = "<p style = 'color:#fff;'>Dados Epidemiológicos Editado com sucesso</p>";
    header("Location: adm_listarMeiosDePreven.php");
}else {
    $_SESSION['msg'] = "<p style = 'color:#fff;'>Dados Epidemiológicos não foi Editado com sucesso</p>";
