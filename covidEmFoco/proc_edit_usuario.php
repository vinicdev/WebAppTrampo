...
//Inserindo formato
$result_usuarios = "UPDATE login SET usuario='$usuario', modified=NOW() WHERE id='$id'";
...
if(mysqli_affected_rows($conn)){
    $_SESSION['msg'] = "<p style = 'color:#fff;'>Usuário Editado com sucesso</p>";
    header("Location: adm_listarUsuario.php");
}else {
    $_SESSION['msg'] = "<p style = 'color:#fff;'>Usuário não foi Editado com sucesso</p>";
